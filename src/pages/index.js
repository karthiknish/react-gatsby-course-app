  ...
  <Layout>
    ...
    <div className="Hero">
      <div className="HeroGroup">
        <h1>
          Learn to <br />
          design and code with React apps
        </h1>
        <p>
          Complete courses about thebest tools and design systems.Prototype and
    ...
    <SectionCellGroup>
      {staticdata.cells.map(cell => {
        return <Cell key={cell.title} title={cell.title} image={cell.image} />
      })}
    </SectionCellGroup>
  </Layout>
)
